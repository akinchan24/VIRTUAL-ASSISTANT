...
try {
 ...
 setIsAuthenticated(true)
  ...
  return (
   ...
   <form className='robotic-panel w-full max-w-[500px] min-h-[520px] sm:h-[600px] flex flex-col items-center justify-center gap-[16px] sm:gap-[20px] px-[16px] sm:px-[38px] py-8' onSubmit={handleSignIn}>
  <p className='robotic-status px-3 py-1 text-[11px] mb-1'>Secure access terminal</p>
  <h1 className='robotic-title text-white text-[24px] sm:text-[30px] font-semibold mb-[20px] sm:mb-[30px] text-center'>Sign In to <span>Virtual Assistant</span></h1>
...
<button className='robotic-button min-w-[150px] h-[52px] sm:h-[60px] mt-[20px] sm:mt-[30px] text-[#041013] font-semibold rounded-lg text-[17px] sm:text-[19px] ' disabled={loading}>{loading?"Loading...":"Sign In"}</button>
